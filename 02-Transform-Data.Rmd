...
<!-- rewrite these and some other examples using warwick such that they make more sense -->
...
- The [Working With Data Primer](https://rstudio.cloud/learn/primers/2) from [RStudio Cloud](http://rstudio.cloud)
