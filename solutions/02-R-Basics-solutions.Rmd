...
The following code loads the _readxl_ package, and loads data from the specified range of `warwick.xlsx`. What happens when you remove the `range` argument? Or the `sheet` argument?
