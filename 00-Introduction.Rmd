...
Do you remember how to load the core tidyverse packages? Load them in the chunk below:
...
To make learning R visualization more fun in the context of geology, we will also load a package called "geoscidata" in all of our exercises.

```{r}
# I've already installed the geodatasci package on this server
# So all you need to do is load it
